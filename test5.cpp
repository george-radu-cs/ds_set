/* test 5 - 1 set with few items: 10 000 000 */
...
int main() {
  ...
  /* create the data for the test and write to test5.in */
  long long int n = 10000000; /* no of elements */
  long long int lower_bound{-1000000000}, upper_bound{1000000000};
  ...
  /* write the data */
  std::ofstream create_fout("test5.in");
