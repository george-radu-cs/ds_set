/* test 2 - 1 set with few items: 100 */
...
int main() {
  ...
  /* create the data for the test and write to test2.in */
  long long int n = 100; /* no of elements */
  long long int lower_bound{-10000}, upper_bound{10000};
  ...
  /* write the data */
  std::ofstream create_fout("test2.in");
